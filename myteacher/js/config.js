// QAcademy MyTeacher — Configuration
// Auto-detects dev vs prod by hostname.
// PAYMENTS_API_BASE excluded — MyTeacher has no payment flow yet.
// ────────────────────────────────────────────────────────────────
...
const EMAIL_WORKER_URL = IS_PROD
  ? 'https://qacademy-myteacher-email-worker.mybackpacc.workers.dev'
  : 'https://qacademy-dev-myteacher-email-worker.mybackpacc.workers.dev';
