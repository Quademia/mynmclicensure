...
- 2026-09-15 — 9a, 9b, 14a, 14b, 12a built: payments, admin Payments / Users / dashboard / Attempts, student messaging with live replies; first prod release
  - ↳ 9, 14 and 12 split on one branch · 7f narrowed · §9 #20–#24 (two fixed) · password in the dev log → FormData · one Quademia account → after · prod: 11 migrations, licensure-prod up, paid products archived · branch rule the MyNclex way
