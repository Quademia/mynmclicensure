...
- ⬜ C1 The link table — product_courses with keys, the Products page and five readers on it, the word list dropped (S8; D16)
- ⬜ C2 The access rows — course_access from the five writers, the gate one lookup, stored dates (S8; D13–D17, D20) — after S2
- ⬜ C3 Stacking on, admin forms per row — queued start, hand-picked grant, Update per row (S8 rulings 3, 5, 6) — after cutover
