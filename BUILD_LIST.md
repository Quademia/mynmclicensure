...
- ⬜ 6a Runner — attempts table, Quiz Builder, the shared core with the instant mode, resume, review
- ⬜ 6b Runner — the timed mode: server-stamped start, countdown, auto-submit
